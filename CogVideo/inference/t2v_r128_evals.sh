...
sbatch t2v_r128.sh $CHECKPOINT true
...
sbatch t2v_r128.sh $CHECKPOINT true scale
...
sbatch t2v_r128.sh $CHECKPOINT false steps
...
sbatch t2v_r128.sh $CHECKPOINT true frames
