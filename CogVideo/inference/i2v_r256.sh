...
LORA_PATH="../models/loras/IDR0013-10plates-i2v-r256-a128/checkpoint-${CHECKPOINT}"
GENERATE_TYPE="i2v"
...
# Output folder
OUTDIR="../../data/generated/test_generations_realval/i2v_r256_${CHECKPOINT}"
mkdir -p "$OUTDIR"
