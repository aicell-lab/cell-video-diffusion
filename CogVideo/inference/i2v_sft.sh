...
SFT_PATH="../models/sft/IDR0013-10plates-i2v-1/checkpoint-${CHECKPOINT}-fp32"
GENERATE_TYPE="i2v"
...
# Output folder
OUTDIR="../../data/generated/test_generations_realval/sft_i2v_${CHECKPOINT}"
mkdir -p "$OUTDIR"
