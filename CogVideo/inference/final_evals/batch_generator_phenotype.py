...
def generate_videos_from_config(config_file: str):
    ...
    for task in config.get("tasks", []):
        ...
        # Set phenotype tensor to the pipe (assuming it has this method)
        if hasattr(pipe, "set_phenotype_tensor"):
            pipe.set_phenotype_tensor(phenotype_tensor)
        else:
            logging.warning("Pipeline doesn't have 'set_phenotype_tensor' method. Attempting to work with standard model.")
