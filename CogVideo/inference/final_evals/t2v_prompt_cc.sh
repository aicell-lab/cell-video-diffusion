...
# -------------------------------
# PROMPT SETUP FOR CELL COUNT
# -------------------------------
# Define the prompts based on condition
if [[ "$CONDITION" == "HIGH" ]]; then
  PROMPT="Time-lapse microscopy video of many cells."
else
  PROMPT="Time-lapse microscopy video of a few cells."
fi
...
OUTDIR="../../../data/generated/final_evals/prompt_cc"
mkdir -p "$OUTDIR"
...
echo "All done! Generated $NUM_VIDEOS text-conditioned videos for cc-$CONDITION in $PHENO_DIR" 