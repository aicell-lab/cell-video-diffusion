...
DATA_ARGS=(
    ...
    --phenotype_column "phenotypes.csv"  # Path to phenotype data file
...
VALIDATION_ARGS=(
    ...
    --validation_phenotypes "phenotypes.csv"  # Added phenotype file for validation
    --gen_fps 10
)
