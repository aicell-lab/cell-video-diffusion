...
def generate_video(
    ...
    - lora_scale (float): The scale factor for LoRA weights when fusing.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lora_scale", type=float, default=1.0, help="The scale factor for LoRA weights when fusing")
